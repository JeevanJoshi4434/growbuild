...
const AllProjects = lazy(() => import("./views/Projects/AllProjects"));
const ViewDev = lazy(() => import("./views/pages/Developers/AllDevs"));
const AddBlock = lazy(() => import("./views/pages/Blocks/CreateBlock"));
const AllBlock = lazy(() => import("./views/pages/Blocks/ViewBlock"));
const AllBooking = lazy(() => import("./views/pages/Bookings/Booking"));
const AddBooking = lazy(() => import("./views/pages/Bookings/SetBooking"));
const AddStage = lazy(() => import("./views/pages/Deemand/CreateStage"));
...
const Maintenance = lazy(() => import("./views/pages/Maintanence/Maintanence.jsx"));
...
const SaleInventorymaster = lazy(() =>
  import("./views/pages/Sales/SaleInventoryMaster")
);
const bookingStatus = lazy(() => import("./views/pages/Booking/BookingStatus"));
const dev = lazy(() => import("./views/pages/Developers/Developers"));
const buyermaster = lazy(() => import("./views/BuyerMaster/BuyerMaster"));
    ...
    return (
      ...
      <Router history={history}>
        <Switch>
          ...
          <AppRoute exact path="/buyer-master" component={buyermaster} />
          <AppRoute exact path="/projects/all" component={AllProjects} />
          <AppRoute exact path="/block/create" component={AddBlock} />
          <AppRoute exact path="/block/all" component={AllBlock} />
          <AppRoute exact path="/booking/all" component={AllBooking} />
          <AppRoute exact path="/booking/create" component={AddBooking} />
          <AppRoute exact path="/deemand/all" component={AllDeemand} />
          <AppRoute exact path="/deemand/create" component={AddStage} />
          <AppRoute exact path="/flat/create" component={AddFlat} />
          <AppRoute exact path="/flat/all" component={AllFlat} />
          <AppRoute exact path="/parking/all" component={AllParking} />
          ...
          <AppRoute
            exact
            path="/sale/sale-inventory"
            component={SaleInventorymaster}
          />
          <AppRoute exact path="/payment/recieve" component={paymentRecieve} />
          <AppRoute
